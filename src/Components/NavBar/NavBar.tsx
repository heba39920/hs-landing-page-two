        ...
        <div className="bg-[var(--main-color)] lg:px-12  rounded-full">
          ...
          >
            <div className="flex lg:flex-nowrap flex-wrap items-center justify-between">
              ...
              <div
                id="navbar-default"
            className={`transition-all duration-800 lg:opacity-100 lg:max-h-full ${toggled ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}  w-full lg:block lg:w-auto overflow-hidden`}
              >
